...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Create analytics stubs and documentation from JSON schema')
    parser.add_argument(
        'schema_paths',
        nargs='+',
        help='The JSON schema files to process'
    )
    parser.add_argument(
        '-l',
        '--language',
    ...
    if args.output_language == "html":
        generate_documentation(args.schema_paths, os.path.join(args.output_dir, "index.html"))
    else:
